...
function HTT_DodgeRoll_Events()
	...
	--d(eventCode.."-"..result.."-"..abilityName.."-"..abilityId.."-"..targetType.."-"..powerType.."-"..hitValue)
	end)
...
function HTT_DodgeRoll_RegisterEvent(abilityID,duration,notOnlyPlayer,sound,texture,dodgeDurationOverride,onlyBlock,preventDouble,nameOverride,sourceNameOverride)
	...
	if (result == ACTION_RESULT_BEGIN and ((targetType == COMBAT_UNIT_TYPE_PLAYER) or notOnlyPlayer) and (preventDouble==nil or preventDouble==hitValue)) then
